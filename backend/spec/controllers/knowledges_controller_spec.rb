...
RSpec.describe Api::V1::KnowledgesController, type: :controller do
  ...
  describe "GET #index" do
    context "キーワード検索" do
      let!(:knowledge1) { create(:knowledge, user:, title: "KnowTEST", content: "test1") }
      let!(:knowledge2) { create(:knowledge, user:, title: "Knowledge", content: "test2") }
      let!(:knowledge3) { create(:knowledge, user:, title: "Foo", content: "test3") }
  ...
  describe "GET #show" do
    context "対象のデータを取得できる" do
      let(:knowledge) { create(:knowledge, user:) }
